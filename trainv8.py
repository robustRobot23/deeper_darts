...
# yolo task=detect mode=train epochs=100 data=data_custom.yaml model=models/yolov8n.pt imgsz=800 verbose=True project=DeeperDarts name=droput_0.1 batch=8 iou=0.3 cos_lr=True lr0=1E-3 optimizer=Adam augment=True save_conf=True plots=True dropout=0.1